...
(() => {
  ...
  const io = new IntersectionObserver((entries) => {
    entries.forEach(e => {
      if (e.isIntersecting) {
        ...
        // stat counters
        if (e.target.classList.contains('hero-stats') || e.target.classList.contains('hero-stats-section')) {
  ...
  document.querySelectorAll('.reveal, .skills, .hero-stats').forEach(el => io.observe(el));
